...
function calcular(){
    ...
    switch(operacion.oper){
        case 1:
               ...
               break;
        case 2:
               doccument.getElementById("resultado").value=operacion.resta();
               break;
        case 3:
               doccument.getElementById("resultado").value=operacion.multiplicacion();
               break;
        case 4:
               doccument.getElementById("resultado").value=operacion.division();
               break;
    }
}